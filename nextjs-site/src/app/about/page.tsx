  ...
  return (
    <SiteShell heroTitle="About" heroSubtitle="About me and my film education.">
      <section className="container">
        ...
        <ul>
          <li>Save the Cat: The Last Book on Screenwriting You&apos;ll Ever Need - Blake Snyder</li>
          <li>The Anatomy of Story: 22 Steps to Become a Master Storyteller - John Truby</li>
          <li>
